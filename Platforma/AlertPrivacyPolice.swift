...
1. Informacje ogólne
Vasily Sevostian szanuje prawo Użytkowników do prywatności oraz dba o bezpieczeństwo danych udostępnionych przez Użytkowników. Szczególnie przywiązuje wagę do poszanowania prywatności Użytkowników, których dane osobowe są przetwarzane zgodnie z ustawą z dnia 10 maja 2018 r. o ochronie danych osobowych, służąca stosowaniu rozporządzenia Parlamentu Europejskiego i Rady UE nr 2016/679 z dnia 27 kwietnia 2016 roku (ogólne rozporządzenie o ochronie danych – «RODO»). Vasily Sevostian dokłada szczególnej staranności w stosowaniu zabezpieczenia danych, stosując odpowiednie rozwiązania technologiczne zapobiegając ingerencji w prywatność Użytkowników osób trzecich.
Administratorem danych osobowych jest działająca pod nazwą domeną sprava.pl firma:
Vasily Sevostian
ul. Dzieci Warszawy 27b/72,
02-495, Warszawa,
Polska
NIP 5223220764 ,REGON 521465164.
Dane osobowe przetwarzane są w celu realizacji zamówień, usług świadczonych przez Vasily Sevostian. Dane uzyskane w procesie rejestracji będą wykorzystywane przez Vasily Sevostian jedynie do obsługi realizacji zamówień i nie są udostępniane osobom postronnym.
...
Vasily Sevostian wykonuje cyklicznie kopie zapasowe serwisów www i poczty elektronicznej. Ponadto Vasily Sevostian stosuje między innymi zabezpieczenia antyspamowe oraz antywirusowe. Oprogramowanie i systemy bezpieczeństwa są na bieżąco aktualizowane.
Zapytania oraz wnioski, dotyczące zakresu przetwarzania danych osobowych, można przesyłać pocztą tradycyjną na adres: ul. Dzieci Warszawy 27b/72, 02-495, Warszawa, oraz mailem na adres info@sprava.pl
"""
